...
#
# whipline.o: src/whipline.c
# 	$(CC) $(INCLUDES) $(CFLAGS) -c  $< -o whipline.o
#
...
gfx:
	$(GCONVERT_DIR)gconvert data/gfx/tiles.xml
	$(GCONVERT_DIR)gconvert data/gfx/spriteTiles.xml
